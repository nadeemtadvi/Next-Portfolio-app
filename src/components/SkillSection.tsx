    ...
    <div className=" dark:bg-darkbgcolor ">
      <div className=" max-w-screen-xl mx-auto py-8 px-4 sm:px-8  lg:py-12">
        <div className=" mx-auto">
          ...
          >
            <h6 className=" inline-block w-[240px]   text-[1.8rem]  font-light border border-buttonColor bg-secondaryColor  dark:-darkprimaryColor">
              {Skills.skill} & Exp.
            </h6>
          </div>
          <div className="relative pt-8 lg:pt-12 lg:grid grid-cols-2">
            ...
            <div className="pt-8 sm:pt-12 lg:pt-0  Skills-part xl:ml-10">
              <div className=" text-center">
                <div className="">
                  <div className="secondaryColorspace-nowrap   grid grid-cols-2  text-primaryColor dark:text-secondaryColor">
                    {Multiskill.map((item, index) => (
                      <div
                        key={index}
                        className="border-b border-buttonColor grid grid-cols-[42px_auto] items-center overflow-hidden  bg-secondaryColor py-2 sm:p-5 dark:bg-darkytext  "
                      >
                        <span className=" text-[#ff7a5c]  dashedBorder bg-secondaryColor text-[0.96rem]  sm:text-[1.2rem] dark:text-primaryColor rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center   ">
                          {item.icon && <item.icon />}
                        </span>
