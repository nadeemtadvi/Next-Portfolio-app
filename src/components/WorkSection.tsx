...
const WorkSection = ({ darkMode }: WorkSectiondataprops) => {
  return (
    <div className=" flex items-center justify-center h-full w-full">
      <div className="dark:bg-blackshadow lg:mx-10 xl:mx-auto border   overflow-hidden bg-white xl:w-[380px] shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)]">
        <div className="relative py-2 px-4 border-b-2  bg-purplereg">
          <span className=" dark:text-darkytext text-[1.4rem]   text-[#252525] font-semibold uppercase ">
            {Works.button}
          </span>
          <Image
            src={dotImg}
        ...
        <div className="scroll-style p-3  overflow-y-auto lg:h-[400px]">
          <div className="m-4 float-right flex  justify-center border  shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)] items-center transform transition-transform duration-300 ease-in-out hover:scale-105">
            <Image
