...
const WorkSection = ({ darkMode }: WorkSectiondataprops) => {
  return (
    <div className=" flex items-center justify-center h-full w-full">
      <div className="dark:bg-blackshadow lg:mx-10 xl:mx-auto border   bg-white  ">
        ...
        <div className=" p-8 ">
          ...
          <div>
            <div className="">
              <h4 className="text-[1.82rem] leading-none text-[#272727] dark:text-darktext font-medium mb-3 ">
                {Works.title}<br/>
                <span className="text-[1rem] italic text-titletext dark:text-darktext font-normal">
                  {" "}
                  ({Works.startDate} - {Works.endDate})
                </span>
              </h4>
              <p className="text-[1.24rem] font-light text-subtext dark:text-darktext mb-2 sm:mb-4">
                {Works.subtitle}
              </p>
            </div>
          </div>
