  ...
  return (
    <div className="footer border-t border-gray-300">
      <div className="p-5 flex justify-between items-center">
        <h4 className="text-[0.8rem] text-subtext dark:text-darksubtext">
          {Footer.copyright}
        </h4>
        <h4 className="text-[0.8rem] text-subtext dark:text-darksubtext">
          {Footer.dev}
        </h4>
        <div className="flex-wrap flex justify-between items-center gap-1 sm:gap-5 text-mainColor dark:text-white text-[24px]">
          <FaSquareInstagram />
          <FaSquareWhatsapp />
