        ...
        <div className=" mx-auto max-w-screen-xl  ">
          <div className="md:grid grid-cols-[200px_auto] lg:grid-cols-[324px_auto] gap-4 lg:gap-10   lg:py-28 px-4 sm:px-8 py-12">
            ...
            <div className="relative flex items-center justify-center mx-4 md:mx-10 lg:mx-16">
              <p className="bg-yellowlight border-2  shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)]  border-blackshadow text-[1.04rem] p-5 rounded-[10px] text-subtext dark:text-darksubtext mb-2 sm:mb-4 text-justify">
                {AboutMe.subtitle}
              </p>
              <div className="">
              <Image
