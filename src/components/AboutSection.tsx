...
const AboutSection = ({ darkMode }: AboutSectiondataprops) => {
  return (
    <div className="">
      <div className="overflow-x-hidden secondaryColorspace-nowrap bg-purplereg dark:bg-primaryColor border-t border-b border-buttonColor text-[18px] sm:text-[20px] font-normal text-primaryColor dark:text-secondaryColor">
        ...
        <div className=" mx-auto max-w-screen-2xl  ">
          <div className="max-w-screen-lg mx-auto lg:pb-12 lg:pt-24  pb-8 pt-16">
            ...
            <div className="boxShadow relative flex items-center justify-center mx-4 md:mx-10 lg:mx-16">
              <p className=" border font-light  dark:bg-darkytext    text-[18px] sm:text-[20px] p-4 sm:p-12  text-primaryColor dark:text-secondaryColor  ">
                {AboutMe.subtitle}
              </p>
              <div className="">
                <Image
