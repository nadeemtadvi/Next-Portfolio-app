                    ...
                    <div className="bg-purplereg dark:bg-darkytext  p-5  ">
                      <div className="">
                        ...
                        <Link href={item.LiveLink} target="_blank">
                            <div className="flex gap-3 items-center justify-center h-[38px] px-2 sm:px-4 bg-gradient-to-r from-gray-900 to-gray-700 text-white rounded-full dark:text-white   font-light  text-[0.95rem] sm:text-[1.1rem]">
                              <CiGlobe className="text-[1.5rem]"/><span>Website</span>
                            </div>
                          </Link>
                        <div className="self-center  ">
                          <Link href={item.Link} target="_blank">
                            <h4 className="dark:text-[#252525] text-blackshadow font-light bg-[#fafafa] border-2 border-[#e4e4e7] rounded-full text-[0.95rem] sm:text-[1.1rem] flex gap-3 items-center justify-center h-[38px]  px-2 sm:px-4">
