      ...
      <div className=" bg-purplelight  dark:bg-darkbgcolor">
        <div className="max-w-screen-xl mx-auto">
          <div className="">
            ...
            >
              <div className="relative rotate-[14deg] w-[240px]  shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)] p-[5px_20px_6px]  font-medium border   bg-purplereg  dark:-darkblackshadow">
                {Project.project}
                <Image
                      src={pinImage}
                      alt="dp"
          ...
          <div className="relative  lg:grid grid-cols-2  gap-10 sm:px-8 px-4 py-4 sm:py-10 lg:py-24">
            {Project.projectObject.map((item, index) => (
              <div key={index} className="py-4 sm:py-6  lg:py-0">
                {/* Image Section */}
                <div
                  className={` border  m-0 lg:m-0 shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)]    overflow-hidden  w-full  `}
                >
                  <div className="">
                    <Image
                      src={item.image}
                      ...
                      width={100}
                      height={100}
                      className="img-project h-[140px] sm:h-[215px] md:h-[360px] lg:h-[270px]  !w-full  border-b-2  transform transition-transform duration-300 ease-in-out hover:scale-105"
                    />
                      ...
                      <div className="flex justify-between sm:justify-start gap-5 ">
                        <h4 className="text-[#272727]  dark:text-darkytext font-medium text-[0.95rem] sm:text-[1.2rem] md:text-[1.6rem] flex items-center">
                          ...
                          <Link href={item.LiveLink} target="_blank">
                            <span className=" text-[#252525] dark:text-darkytext   font-medium ml-[5px] text-[0.95rem] sm:text-[1.1rem]">
                              Live Demo
                            </span>
                          </Link>
                        </h4>
