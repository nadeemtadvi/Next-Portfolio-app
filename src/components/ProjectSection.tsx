...
const ProjectSection = () => {
  return (
    <div className="mb-2 bg-sectionColor">
      <div className=" p-5">
        <div className="text-center pt-6">
          <button className="mb-[2.5rem] rounded-full bg-mainColorten text-mainColor font-medium p-[2px_20px_3px]">
            {Project.project}
          </button>
        </div>
        <div className="grid grid-cols-2 gap-4">
          {Project.projectObject.map((item, index) => (
            <div key={index} className="p-5">
              ...
              <div>
                <div>
                  <h4 className="text-[2rem] text-titletext font-medium mb-4">
                    {item.title}
                  </h4>
                  <p className="text-[1.04rem] text-subtext mb-4 ">
                    {item.subtitle}
                  </p>
